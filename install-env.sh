...
if [ $# != 6 ]
then echo "Provide 6 arguments in the following order to run the script successfully!! 
 1 -- AMI-IMAGE ID 
 2 -- Key Name  
 3 -- Security Group 
...
aws ec2 run-instances --image-id $1 --key-name $2 --security-group-ids $3 --instance-type $instanceType --placement $placementZone --count $5 --user-data $File --client-token $clientToken --iam-instance-profile Name=$6
